...
class Q95TH extends org.apache.spark.sql.expressions.UserDefinedAggregateFunction{
  def inputSchema: org.apache.spark.sql.types.StructType =
    org.apache.spark.sql.types.StructType(org.apache.spark.sql.types.StructField("value", org.apache.spark.sql.types.DoubleType) :: Nil)
  ...
  def evaluate(buffer: org.apache.spark.sql.Row): Any = {
    var sortedWindow = buffer.getAs[scala.collection.mutable.WrappedArray[Double]](0).sorted.toBuffer
    var windowSize = sortedWindow.size
    var q95Th = computePercentile(sortedWindow,95,false)
    q95Th
  }
...
/**
  * Calculate n quantile
  * @param n
  */
class QnTH(n: Int) extends org.apache.spark.sql.expressions.UserDefinedAggregateFunction{
  def inputSchema: org.apache.spark.sql.types.StructType =
    org.apache.spark.sql.types.StructType(org.apache.spark.sql.types.StructField("value", org.apache.spark.sql.types.DoubleType) :: Nil)
  ...
  def evaluate(buffer: org.apache.spark.sql.Row): Any = {
    ...
    var qnTh = computePercentile(sortedWindow,nth,false)
    qnTh
  }
